package com.riameeting.finger.flex.component
{
	...
	{
		private var chart:com.riameeting.finger.component.ColumnChart;
		...
		public function get chartInstance():com.riameeting.finger.component.ColumnChart
		{
			return chart;
		}
		...
		override protected function createChildren():void
		{
			...
			chart = new com.riameeting.finger.component.ColumnChart(minWidth,minHeight);
			addChild(chart);
		}
