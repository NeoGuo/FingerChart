package com.riameeting.finger.display.container 
{
	 ...
	 * @author 黄龙
	 */
	public class Pie3DTooltipContaniner extends TooltipContainer 
	{
		
		public function Pie3DTooltipContaniner(chartRef:IChart, tooltipClass:Class, checkType:String="byx") 
		{
		...
		override protected function containerMouseHandler(e:MouseEvent):void 
		{
			...
			for each (nextGraphic in graphicsCollection)
			{
				...
				if ((nextGraphic as DisplayObjectContainer).hitTestPoint(mousePoint.x, mousePoint.y,true))
				{
