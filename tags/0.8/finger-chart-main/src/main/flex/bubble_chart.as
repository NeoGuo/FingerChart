package
{
	 ...
	 */	
	[SWF(backgroundColor="#FFFFFF",pageTitle="BubbleChart")]
	public class bubble_chart extends ChartWrapper
	{
		/**
		 * 构造方法
		 * 
		 */		
		public function bubble_chart() {
			super();
		}
		/**
		 * 初始化方法，将创建图表，并加载外部文件
		...
		override protected function init(e:Event=null):void {
			chart = new BubbleChart(stage.stageWidth,stage.stageHeight);
